...
// Palette, styles de base, pilule de statut et tracé de courbe sont désormais
// partagés avec l'Accueil livreur (§ components/dashboard/composition.tsx) :
// les deux écrans reprennent la même composition, et une teinte corrigée ici
// ne pouvait pas rester en arrière là-bas.
const BLANC = '#FFFFFF';
...
// Réexporté pour que lib/dashboard-accueil.ts continue de tirer le type d'ici,
// avec le reste du contrat de données qu'il alimente — le déménagement du
// vocabulaire visuel n'a pas à remonter jusqu'à lui.
